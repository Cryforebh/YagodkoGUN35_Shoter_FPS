...
public class AiAgent : MonoBehaviour
{
    ...
    [HideInInspector] public AiRigControl rigControl;
    [HideInInspector] public SoundAnimationLocomotion sound;
    ...
    void Start()
    {
        ...
        rigControl = GetComponent<AiRigControl>();
        sound = GetComponent<SoundAnimationLocomotion>();
